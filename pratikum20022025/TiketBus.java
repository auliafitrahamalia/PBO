...
public class TiketBus {
    public static void main(String [] args){
        ...
        System.out.println("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX|");
        System.out.println("|    1.Ekonomi          |   Rp.350.00,00    |");
        System.out.println("|    2.Eksekutif        |   Rp.500.00,00    |");
        System.out.println("|    3.SuperEksekutif   |   Rp.650.00,00    |");
        System.out.println("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX|");
        System.out.print("Pilih tiket (angka) : ");
        menu = in.nextInt();
        System.out.printf("Masukkan jumlah tiket : ");
